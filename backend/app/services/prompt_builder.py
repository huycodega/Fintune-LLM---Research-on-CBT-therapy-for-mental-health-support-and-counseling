...
def build_messages(user_input_scrubbed: str,
    ...
    blocks = [
        ...
        "EMPHASIS: In the Response, wrap the 1-3 MOST important words or the key "
        "action/technique in **double asterisks** (markdown bold) so they stand "
        "out to the client — sparingly, never whole sentences.\n"
